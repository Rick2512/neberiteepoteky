...
const activeBank = activeButtuon => {
  const dataValue = activeButtuon.dataset.name;
...
const calc = (totalCost = 0, initalFee = 50000, creditTerm = 1) => {
  ...
  let monthlyPayment = (amountLoan + (((amountLoan * interestRate) / 100) * amountMonth) / 12) / amountMonth;
